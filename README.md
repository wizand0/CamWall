...
- Live view: FFmpeg-сеанс пишет `cache/live/frame_%05d.jpg` с low-latency флагами (`-fflags nobuffer -flags low_delay`); UI опрашивает каталог каждые 100 мс и показывает последний полностью записанный кадр.
